...
public:
    ...
    virtual int HookTradeRequestOpen(
        const TradeRecord&, const GroupRecord&, const SymbolRecord&, const AccountRecord&, const MarginLevel&,
        TradeDiffRecord&
    ) { return RET_OK; }
...
public:
    ...
    virtual int CustomAction(rapidjson::Value& req, rapidjson::Value& res,
                             rapidjson::Document::AllocatorType& allocator) { return RET_OK_NONE; }
};
